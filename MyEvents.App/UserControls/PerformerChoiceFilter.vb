...
Namespace Global.MyEvents.App.UserControls
    Public Class PerformerChoiceFilter
        ...
        Private Async Sub PopulateChoices()
            Dim performers = Await App.Repository.Performers.GetAsync()
        ...
        Public Overrides Function PassesFilter(item As Object) As Boolean
            ...
            Dim matches = Choices.Where(Function(x) x.IsChecked AndAlso
                                            If(String.IsNullOrEmpty(x.Value),
                                               String.IsNullOrEmpty(entry.Contributors),
                                               entry.Contributors.Contains(x.Value, StringComparison.InvariantCultureIgnoreCase))).FirstOrDefault()
